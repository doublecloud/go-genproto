...
var file_doublecloud_clickhouse_v1_backup_proto_rawDesc = []byte{
...
var (
	...
	file_doublecloud_clickhouse_v1_backup_proto_rawDescData = file_doublecloud_clickhouse_v1_backup_proto_rawDesc
)
...
func file_doublecloud_clickhouse_v1_backup_proto_rawDescGZIP() []byte {
	file_doublecloud_clickhouse_v1_backup_proto_rawDescOnce.Do(func() {
		file_doublecloud_clickhouse_v1_backup_proto_rawDescData = protoimpl.X.CompressGZIP(file_doublecloud_clickhouse_v1_backup_proto_rawDescData)
	})
...
var file_doublecloud_clickhouse_v1_backup_proto_goTypes = []interface{}{
...
func file_doublecloud_clickhouse_v1_backup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_clickhouse_v1_backup_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Backup); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_doublecloud_clickhouse_v1_backup_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_doublecloud_clickhouse_v1_backup_proto_rawDesc = nil
