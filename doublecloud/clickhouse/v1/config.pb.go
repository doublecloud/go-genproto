...
func file_doublecloud_clickhouse_v1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_doublecloud_clickhouse_v1_config_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_clickhouse_v1_config_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
