...
func (x *Transformer) GetJsonMapperTransformer() *JsonParserTransformer {
	if x, ok := x.GetTransformer().(*Transformer_JsonMapperTransformer); ok {
...
func file_doublecloud_transfer_v1_transfer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_doublecloud_transfer_v1_transfer_proto_msgTypes[33].Exporter = func(v any, i int) any {
			switch v := v.(*JsonParserTransformer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_transfer_v1_transfer_proto_msgTypes[35].Exporter = func(v any, i int) any {
