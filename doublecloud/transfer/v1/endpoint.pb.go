...
func (x *EndpointSettings) GetDynamodbSource() *airbyte.DynamodbSource {
	if x, ok := x.GetSettings().(*EndpointSettings_DynamodbSource); ok {
...
var file_doublecloud_transfer_v1_endpoint_proto_rawDesc = []byte{
	...
	0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x34, 0x22, 0xfe, 0x17, 0x0a,
	...
	0x62, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x65, 0x74, 0x74, 0x69,
	...
	0x8c, 0x01, 0x10, 0x94, 0x01, 0x4a, 0x06, 0x08, 0x95, 0x01, 0x10, 0x99, 0x01, 0x4a, 0x06, 0x08,
	0x9f, 0x01, 0x10, 0xa0, 0x01, 0x4a, 0x06, 0x08, 0xa1, 0x01, 0x10, 0xa3, 0x01, 0x42, 0x45, 0x5a,
...
func file_doublecloud_transfer_v1_endpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_transfer_v1_endpoint_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_doublecloud_transfer_v1_endpoint_proto_msgTypes[1].Exporter = func(v any, i int) any {
