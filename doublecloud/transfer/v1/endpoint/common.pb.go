...
func file_doublecloud_transfer_v1_endpoint_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_doublecloud_transfer_v1_endpoint_common_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_transfer_v1_endpoint_common_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoAuth); i {
			case 0:
				return &v.state
			case 1:
	...
	file_doublecloud_transfer_v1_endpoint_common_proto_msgTypes[9].OneofWrappers = []interface{}{
