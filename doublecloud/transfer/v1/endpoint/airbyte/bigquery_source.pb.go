...
var file_doublecloud_transfer_v1_endpoint_airbyte_bigquery_source_proto_goTypes = []interface{}{
...
func file_doublecloud_transfer_v1_endpoint_airbyte_bigquery_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_transfer_v1_endpoint_airbyte_bigquery_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
