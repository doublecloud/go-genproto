...
var file_doublecloud_transfer_v1_endpoint_airbyte_aws_cloud_trail_source_proto_goTypes = []interface{}{
...
func file_doublecloud_transfer_v1_endpoint_airbyte_aws_cloud_trail_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_transfer_v1_endpoint_airbyte_aws_cloud_trail_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AWSCloudTrailSource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
