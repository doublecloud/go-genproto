...
var file_doublecloud_transfer_v1_endpoint_airbyte_hubspot_source_proto_goTypes = []interface{}{
...
func file_doublecloud_transfer_v1_endpoint_airbyte_hubspot_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_transfer_v1_endpoint_airbyte_hubspot_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HubspotSource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_transfer_v1_endpoint_airbyte_hubspot_source_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HubspotSource_Credentials); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_transfer_v1_endpoint_airbyte_hubspot_source_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HubspotSource_Credentials_PrivateApp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_doublecloud_transfer_v1_endpoint_airbyte_hubspot_source_proto_msgTypes[1].OneofWrappers = []interface{}{
