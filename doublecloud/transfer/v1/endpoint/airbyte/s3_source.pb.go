...
func (x *S3Source_Format) GetFormat() isS3Source_Format_Format {
	if x != nil {
		return x.Format
	}
	return nil
...
func (x *S3Source_Format) GetCsv() *S3Source_Csv {
	if x != nil {
		if x, ok := x.Format.(*S3Source_Format_Csv); ok {
			return x.Csv
		}
	}
	return nil
...
func (x *S3Source_Format) GetParquet() *S3Source_Parquet {
	if x != nil {
		if x, ok := x.Format.(*S3Source_Format_Parquet); ok {
			return x.Parquet
		}
	}
	return nil
...
func (x *S3Source_Format) GetAvro() *S3Source_Avro {
	if x != nil {
		if x, ok := x.Format.(*S3Source_Format_Avro); ok {
			return x.Avro
		}
	}
	return nil
...
func (x *S3Source_Format) GetJsonl() *S3Source_Jsonl {
	if x != nil {
		if x, ok := x.Format.(*S3Source_Format_Jsonl); ok {
			return x.Jsonl
		}
	}
	return nil
...
var file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDescData []byte
)
...
func file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDescGZIP() []byte {
	file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDescOnce.Do(func() {
		file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDesc), len(file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDesc)))
	})
...
var file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_goTypes = []any{
...
func file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_init() {
	...
	file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDesc), len(file_doublecloud_transfer_v1_endpoint_airbyte_s3_source_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
