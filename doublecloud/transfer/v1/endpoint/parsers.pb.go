...
func file_doublecloud_transfer_v1_endpoint_parsers_proto_init() {
	...
	file_doublecloud_transfer_v1_endpoint_parsers_proto_msgTypes[3].OneofWrappers = []any{
		(*ProtoDesc_DescFile)(nil),
	}
	file_doublecloud_transfer_v1_endpoint_parsers_proto_msgTypes[4].OneofWrappers = []any{
