...
var file_doublecloud_v1_paging_proto_goTypes = []interface{}{
...
func file_doublecloud_v1_paging_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_v1_paging_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Paging); i {
			case 0:
				return &v.state
			case 1:
		...
		file_doublecloud_v1_paging_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
