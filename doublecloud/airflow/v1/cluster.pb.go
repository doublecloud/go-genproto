...
func (m *SyncConfig) GetCredentials() isSyncConfig_Credentials {
	if m != nil {
...
func (x *SyncConfig) GetApiCredentials() *GitApiCredentials {
	if x, ok := x.GetCredentials().(*SyncConfig_ApiCredentials); ok {
...
func file_doublecloud_airflow_v1_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*AirflowEnvVariable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ManagedImageStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*CrConnectionInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*GitApiCredentials); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_doublecloud_airflow_v1_cluster_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*ClusterResources_Airflow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
