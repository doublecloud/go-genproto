...
func file_doublecloud_visualization_v1_workbook_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_doublecloud_visualization_v1_workbook_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_visualization_v1_workbook_service_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
