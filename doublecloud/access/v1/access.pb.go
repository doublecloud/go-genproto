...
var file_doublecloud_access_v1_access_proto_rawDesc = []byte{
...
var (
	...
	file_doublecloud_access_v1_access_proto_rawDescData = file_doublecloud_access_v1_access_proto_rawDesc
)

func file_doublecloud_access_v1_access_proto_rawDescGZIP() []byte {
	file_doublecloud_access_v1_access_proto_rawDescOnce.Do(func() {
		file_doublecloud_access_v1_access_proto_rawDescData = protoimpl.X.CompressGZIP(file_doublecloud_access_v1_access_proto_rawDescData)
	})
...
var file_doublecloud_access_v1_access_proto_goTypes = []interface{}{
...
func file_doublecloud_access_v1_access_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_access_v1_access_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_access_v1_access_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_doublecloud_access_v1_access_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_doublecloud_access_v1_access_proto_rawDesc = nil
