...
const (
	GroupMappingService_Get_FullMethodName         = "/doublecloud.organizationmanager.v1.GroupMappingService/Get"
	GroupMappingService_Create_FullMethodName      = "/doublecloud.organizationmanager.v1.GroupMappingService/Create"
	GroupMappingService_Update_FullMethodName      = "/doublecloud.organizationmanager.v1.GroupMappingService/Update"
	GroupMappingService_Delete_FullMethodName      = "/doublecloud.organizationmanager.v1.GroupMappingService/Delete"
	GroupMappingService_ListItems_FullMethodName   = "/doublecloud.organizationmanager.v1.GroupMappingService/ListItems"
	GroupMappingService_UpdateItems_FullMethodName = "/doublecloud.organizationmanager.v1.GroupMappingService/UpdateItems"
)
...
type GroupMappingServiceClient interface {
	...
	Create(ctx context.Context, in *CreateGroupMappingRequest, opts ...grpc.CallOption) (*v1.Operation, error)
	...
	Update(ctx context.Context, in *UpdateGroupMappingRequest, opts ...grpc.CallOption) (*v1.Operation, error)
	// Deletes a group mapping. This will remove all the mapping items
	// cascade.
	Delete(ctx context.Context, in *DeleteGroupMappingRequest, opts ...grpc.CallOption) (*v1.Operation, error)
	...
	// Such parts of request will be ignored. Others will be applied.
	UpdateItems(ctx context.Context, in *UpdateGroupMappingItemsRequest, opts ...grpc.CallOption) (*v1.Operation, error)
}
...
func (c *groupMappingServiceClient) Create(ctx context.Context, in *CreateGroupMappingRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *groupMappingServiceClient) Update(ctx context.Context, in *UpdateGroupMappingRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Operation)
...
func (c *groupMappingServiceClient) Delete(ctx context.Context, in *DeleteGroupMappingRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Operation)
...
func (c *groupMappingServiceClient) UpdateItems(ctx context.Context, in *UpdateGroupMappingItemsRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Operation)
...
// All implementations must embed UnimplementedGroupMappingServiceServer
...
type GroupMappingServiceServer interface {
	...
	// Adds a group mapping for a federation
	// If mapping already exist, ALREADY_EXISTS will be returned
	Create(context.Context, *CreateGroupMappingRequest) (*v1.Operation, error)
	// Updates an existing group mapping for a federation
	// Errors:
	// - if federation is not found
	// In case of any error, no changes are applied to existing group mapping
	...
	// - disabling when disabled
	// Such parts of request will be ignored. Others will be applied.
	Update(context.Context, *UpdateGroupMappingRequest) (*v1.Operation, error)
	// Deletes a group mapping. This will remove all the mapping items
	// cascade.
	Delete(context.Context, *DeleteGroupMappingRequest) (*v1.Operation, error)
	// Returns all the group mappings items
	//
	// Filtering is only supported by external_group_id or internal_group_id
	...
	// - removing group mapping items that are not present
	// Such parts of request will be ignored. Others will be applied.
	UpdateItems(context.Context, *UpdateGroupMappingItemsRequest) (*v1.Operation, error)
	mustEmbedUnimplementedGroupMappingServiceServer()
}

// UnimplementedGroupMappingServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedGroupMappingServiceServer) Create(context.Context, *CreateGroupMappingRequest) (*v1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedGroupMappingServiceServer) Update(context.Context, *UpdateGroupMappingRequest) (*v1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedGroupMappingServiceServer) Delete(context.Context, *DeleteGroupMappingRequest) (*v1.Operation, error) {
...
func (UnimplementedGroupMappingServiceServer) UpdateItems(context.Context, *UpdateGroupMappingItemsRequest) (*v1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateItems not implemented")
}
func (UnimplementedGroupMappingServiceServer) mustEmbedUnimplementedGroupMappingServiceServer() {}
...
var GroupMappingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "doublecloud.organizationmanager.v1.GroupMappingService",
	...
	Metadata: "doublecloud/organizationmanager/v1/group_mapping_service.proto",
}
