...
var file_doublecloud_kafka_v1_topic_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_kafka_v1_topic_proto_rawDescData []byte
)

func file_doublecloud_kafka_v1_topic_proto_rawDescGZIP() []byte {
	file_doublecloud_kafka_v1_topic_proto_rawDescOnce.Do(func() {
		file_doublecloud_kafka_v1_topic_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_kafka_v1_topic_proto_rawDesc), len(file_doublecloud_kafka_v1_topic_proto_rawDesc)))
	})
...
var file_doublecloud_kafka_v1_topic_proto_goTypes = []any{
...
func file_doublecloud_kafka_v1_topic_proto_init() {
	...
	file_doublecloud_kafka_v1_topic_proto_msgTypes[0].OneofWrappers = []any{
		(*Topic_TopicConfig_2_8)(nil),
		(*Topic_TopicConfig_3)(nil),
	}
	file_doublecloud_kafka_v1_topic_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_kafka_v1_topic_proto_rawDesc), len(file_doublecloud_kafka_v1_topic_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
