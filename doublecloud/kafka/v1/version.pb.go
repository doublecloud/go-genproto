...
var file_doublecloud_kafka_v1_version_proto_goTypes = []interface{}{
...
func file_doublecloud_kafka_v1_version_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_kafka_v1_version_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
