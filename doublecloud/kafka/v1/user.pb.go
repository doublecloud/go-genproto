...
var file_doublecloud_kafka_v1_user_proto_goTypes = []interface{}{
...
func file_doublecloud_kafka_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_kafka_v1_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_doublecloud_kafka_v1_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_kafka_v1_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
