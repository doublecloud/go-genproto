...
func file_doublecloud_kafka_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_kafka_v1_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_doublecloud_kafka_v1_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_doublecloud_kafka_v1_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
