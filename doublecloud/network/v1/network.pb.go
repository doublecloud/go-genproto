...
type Network struct {
	...
	//
	// Types that are valid to be assigned to ExternalResources:
	//
	//	*Network_Aws
	//	*Network_Gcp
...
func (x *Network) GetExternalResources() isNetwork_ExternalResources {
	if x != nil {
...
func (x *Network) GetAws() *AwsExternalResources {
	if x != nil {
		if x, ok := x.ExternalResources.(*Network_Aws); ok {
			return x.Aws
		}
	}
	return nil
...
func (x *Network) GetGcp() *GcpExternalResources {
	if x != nil {
		if x, ok := x.ExternalResources.(*Network_Gcp); ok {
			return x.Gcp
		}
	}
	return nil
...
var file_doublecloud_network_v1_network_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_network_v1_network_proto_rawDescData []byte
)
...
func file_doublecloud_network_v1_network_proto_rawDescGZIP() []byte {
	file_doublecloud_network_v1_network_proto_rawDescOnce.Do(func() {
		file_doublecloud_network_v1_network_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_network_v1_network_proto_rawDesc), len(file_doublecloud_network_v1_network_proto_rawDesc)))
	})
...
func file_doublecloud_network_v1_network_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_network_v1_network_proto_rawDesc), len(file_doublecloud_network_v1_network_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
