...
func (c *networkConnectionServiceClient) Get(ctx context.Context, in *GetNetworkConnectionRequest, opts ...grpc.CallOption) (*NetworkConnection, error) {
	...
	err := c.cc.Invoke(ctx, NetworkConnectionService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkConnectionServiceClient) List(ctx context.Context, in *ListNetworkConnectionsRequest, opts ...grpc.CallOption) (*ListNetworkConnectionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, NetworkConnectionService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkConnectionServiceClient) Create(ctx context.Context, in *CreateNetworkConnectionRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	...
	err := c.cc.Invoke(ctx, NetworkConnectionService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *networkConnectionServiceClient) Delete(ctx context.Context, in *DeleteNetworkConnectionRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Operation)
	err := c.cc.Invoke(ctx, NetworkConnectionService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNetworkConnectionServiceServer must be embedded to have
...
func (UnimplementedNetworkConnectionServiceServer) testEmbeddedByValue() {}
...
func RegisterNetworkConnectionServiceServer(s grpc.ServiceRegistrar, srv NetworkConnectionServiceServer) {
	// If the following call pancis, it indicates UnimplementedNetworkConnectionServiceServer was
