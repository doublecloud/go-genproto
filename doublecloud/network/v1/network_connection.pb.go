...
func (x *NetworkConnection) GetConnectionInfo() isNetworkConnection_ConnectionInfo {
	if x != nil {
...
func (x *NetworkConnection) GetAws() *AWSNetworkConnectionInfo {
	if x != nil {
		if x, ok := x.ConnectionInfo.(*NetworkConnection_Aws); ok {
			return x.Aws
		}
	}
	return nil
...
func (x *NetworkConnection) GetGoogle() *GoogleNetworkConnectionInfo {
	if x != nil {
		if x, ok := x.ConnectionInfo.(*NetworkConnection_Google); ok {
			return x.Google
		}
	}
	return nil
...
func (x *AWSNetworkConnectionInfo) GetType() isAWSNetworkConnectionInfo_Type {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *AWSNetworkConnectionInfo) GetPeering() *AWSNetworkConnectionPeeringInfo {
	if x != nil {
		if x, ok := x.Type.(*AWSNetworkConnectionInfo_Peering); ok {
			return x.Peering
		}
	}
	return nil
...
var file_doublecloud_network_v1_network_connection_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_network_v1_network_connection_proto_rawDescData []byte
)
...
func file_doublecloud_network_v1_network_connection_proto_rawDescGZIP() []byte {
	file_doublecloud_network_v1_network_connection_proto_rawDescOnce.Do(func() {
		file_doublecloud_network_v1_network_connection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_network_v1_network_connection_proto_rawDesc), len(file_doublecloud_network_v1_network_connection_proto_rawDesc)))
	})
...
func file_doublecloud_network_v1_network_connection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_network_v1_network_connection_proto_rawDesc), len(file_doublecloud_network_v1_network_connection_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
