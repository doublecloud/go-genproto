...
var file_doublecloud_network_v1_network_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_network_v1_network_service_proto_rawDescData []byte
)
...
func file_doublecloud_network_v1_network_service_proto_rawDescGZIP() []byte {
	file_doublecloud_network_v1_network_service_proto_rawDescOnce.Do(func() {
		file_doublecloud_network_v1_network_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_network_v1_network_service_proto_rawDesc), len(file_doublecloud_network_v1_network_service_proto_rawDesc)))
	})
...
func file_doublecloud_network_v1_network_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_network_v1_network_service_proto_rawDesc), len(file_doublecloud_network_v1_network_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
