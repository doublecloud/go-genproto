...
var file_doublecloud_logs_v1_log_proto_rawDesc = []byte{
	...
	0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x00, 0x12, 0x13, 0x0a, 0x0f, 0x4c, 0x4f, 0x47,
...
var file_doublecloud_logs_v1_log_proto_goTypes = []interface{}{
...
func file_doublecloud_logs_v1_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_doublecloud_logs_v1_log_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_doublecloud_logs_v1_log_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
