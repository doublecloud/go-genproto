...
// UnimplementedLogExportServiceServer must be embedded to have
...
func (UnimplementedLogExportServiceServer) testEmbeddedByValue()                          {}
...
func RegisterLogExportServiceServer(s grpc.ServiceRegistrar, srv LogExportServiceServer) {
	// If the following call pancis, it indicates UnimplementedLogExportServiceServer was
