...
func (x *LogsTarget) GetTarget() isLogsTarget_Target {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *LogsTarget) GetS3() *LogsTargetS3 {
	if x != nil {
		if x, ok := x.Target.(*LogsTarget_S3); ok {
			return x.S3
		}
	}
	return nil
...
func (x *LogsTarget) GetDatadog() *LogsTargetDatadog {
	if x != nil {
		if x, ok := x.Target.(*LogsTarget_Datadog); ok {
			return x.Datadog
		}
	}
	return nil
...
func (x *LogsTarget) GetCoralogix() *LogsTargetCoralogix {
	if x != nil {
		if x, ok := x.Target.(*LogsTarget_Coralogix); ok {
			return x.Coralogix
		}
	}
	return nil
...
func (x *LogsTarget) GetDatadogCompatible() *LogsTargetDatadogCompatible {
	if x != nil {
		if x, ok := x.Target.(*LogsTarget_DatadogCompatible); ok {
...
var file_doublecloud_logs_v1_log_export_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_logs_v1_log_export_proto_rawDescData []byte
)
...
func file_doublecloud_logs_v1_log_export_proto_rawDescGZIP() []byte {
	file_doublecloud_logs_v1_log_export_proto_rawDescOnce.Do(func() {
		file_doublecloud_logs_v1_log_export_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_logs_v1_log_export_proto_rawDesc), len(file_doublecloud_logs_v1_log_export_proto_rawDesc)))
	})
...
func file_doublecloud_logs_v1_log_export_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_logs_v1_log_export_proto_rawDesc), len(file_doublecloud_logs_v1_log_export_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
