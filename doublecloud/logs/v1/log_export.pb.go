...
func file_doublecloud_logs_v1_log_export_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_doublecloud_logs_v1_log_export_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_doublecloud_logs_v1_log_export_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*LogsTarget_S3)(nil),
