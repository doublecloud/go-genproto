...
func (x *ReadLogsRequest) GetSelector() isReadLogsRequest_Selector {
	if x != nil {
		return x.Selector
	}
	return nil
...
func (x *ReadLogsRequest) GetPaging() *v1.NextPage {
	if x != nil {
		if x, ok := x.Selector.(*ReadLogsRequest_Paging); ok {
			return x.Paging
		}
	}
	return nil
...
func (x *ReadLogsRequest) GetCriteria() *Criteria {
	if x != nil {
		if x, ok := x.Selector.(*ReadLogsRequest_Criteria); ok {
			return x.Criteria
		}
	}
	return nil
...
var file_doublecloud_logs_v1_log_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_doublecloud_logs_v1_log_service_proto_rawDescData []byte
)
...
func file_doublecloud_logs_v1_log_service_proto_rawDescGZIP() []byte {
	file_doublecloud_logs_v1_log_service_proto_rawDescOnce.Do(func() {
		file_doublecloud_logs_v1_log_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_doublecloud_logs_v1_log_service_proto_rawDesc), len(file_doublecloud_logs_v1_log_service_proto_rawDesc)))
	})
...
var file_doublecloud_logs_v1_log_service_proto_goTypes = []any{
...
func file_doublecloud_logs_v1_log_service_proto_init() {
	...
	file_doublecloud_logs_v1_log_service_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_doublecloud_logs_v1_log_service_proto_rawDesc), len(file_doublecloud_logs_v1_log_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
